...
class Details extends Component {
  ...
  addToCart(item) {
    ...
    document.querySelector('#detail-temporary-text').classList.toggle('temporary-text-clicked');
    document.querySelector('#detail-temporary-text').classList.toggle('temporary-text-notclicked');
